            ...
            if (active) {
                ...
                for (Brick brick : bricks) {
                    ...
                    if (brick.color == Color.RED) {
                        if (brick.p.x <= redBall[0]+20 && brick.p.x + 40 >= redBall[0]) {
                            if (brick.p.y <= redBall[1]+20 && brick.p.y + 40 >= redBall[1]) {
                                forRemoval.add(brick);
                                score++;
                                redBall[2] *= -1;
                                if (redBall[2] <= 4) redBall[2] = 1;
                    ...
                    if (brick.color == Color.GREEN) {
                        if (brick.p.x <= greenBall[0]+20 && brick.p.x + 40 >= greenBall[0]) {
                            if (brick.p.y <= greenBall[1]+20 && brick.p.y + 40 >= greenBall[1]) {
                                forRemoval.add(brick);
                                score++;
                                greenBall[2] *= -1;
                                if (greenBall[2] <= 4) greenBall[2] = 1;
                    ...
                    if (brick.color == Color.BLUE) {
                        if (brick.p.x <= blueBall[0]+20 && brick.p.x + 40 >= blueBall[0]) {
                            if (brick.p.y <= blueBall[1]+20 && brick.p.y + 40 >= blueBall[1]) {
                                forRemoval.add(brick);
                                score++;
                                blueBall[2] *= -1;
                                if (blueBall[2] <= 4) blueBall[2] = 1;
                ...
                g.fillRect(redBall[0], redBall[1], 20, 20);
                redBall[0] += redBall[2];
                redBall[1] += redBall[3];

                //drawing the green ball
                g.setColor(Color.GREEN);
                g.fillRect(greenBall[0], greenBall[1], 20, 20);
                greenBall[0] += greenBall[2];
                greenBall[1] += greenBall[3];

                //drawing the blue ball
                g.setColor(Color.BLUE);
                g.fillRect(blueBall[0], blueBall[1], 20, 20);
